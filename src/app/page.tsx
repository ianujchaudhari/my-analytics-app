        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-200 via-violet-100 to-pink-100 text-gray-800">
            ...
            <section className="container mx-auto px-4 py-20 text-center">
                ...
                <p className="mb-8 text-xl text-gray-600 max-w-2xl mx-auto">
                    Unlock the Power of Your Social Media Data with Smart
            ...
            {/* Our Team Sections */}
            <section className="py-16 bg-white bg-opacity-50 backdrop-filter backdrop-blur-lg">
                <div className="max-w-2xl mx-auto text-center mb-16">
                    <h2 className="text-4xl font-bold tracking-tight text-gray-900 mb-4">
                        Our Team
                    </h2>
                    <p className="text-lg text-gray-600">
                        Meet the talented individuals behind TrendLytix
                    </p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                    <ProfileCard
                        ...
                        links={[
                            { type: "github", url: "https://github.com/lokeshkhabiya" },
                            { type: "twitter", url: "https://x.com/lokeshstwt" },
                            { type: "linkedin", url: "https://www.linkedin.com/in/lokeshkhabiya"},
                        ]}
                    />
                    <ProfileCard
                        name="Anuj Choudhari" 
                        role="Full Stack Developer"
                        links={[
                            { type: "github", url: "https://github.com/ianujchaudhari/" },
                            { type: "twitter", url: "https://twitter.com/iAnujChoudhari" },
                            { type: "linkedin", url: "https://www.linkedin.com/in/ianujchaudhari"},
                        ]}
                    />
                    <ProfileCard
                        name="Prasad Ware"
                        role="Full Stack Developer" 
                        links={[
                            { type: "github", url: "https://github.com/Prasad-D-Ware" },
                            { type: "twitter", url: "https://twitter.com/prasadtwts" },
                            { type: "linkedin", url: "https://www.linkedin.com/in/prasad-ware/"},
                        ]}
                    />
                </div>
            </section>
            ...
            >
                <div className="container mx-auto px-4">
                    ...
                    <p className="mb-8 text-xl">
                        Start uncovering powerful insights with TrendLytix
                        today!
                    </p>
                    <Button
                        asChild
            ...
            <footer className="flex flex-col gap-2 sm:flex-row py-4 w-full shrink-0 items-center px-4 md:px-6 border-t">
                <p className="text-xs text-gray-500 dark:text-gray-400">
                    © 2025 Trendlytix. All rights reserved.
                </p>
...
function DetailedFeature({
    ...
    return (
        <div className="rounded-lg bg-white bg-opacity-50 backdrop-filter backdrop-blur-lg p-6 shadow-lg hover:shadow-xl transition-all duration-300">
            <h3 className="mb-2 text-2xl font-semibold text-indigo-500">
                {title}
            </h3>
            <p className="text-gray-600">{description}</p>
        </div>
